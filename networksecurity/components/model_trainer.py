...
from networksecurity.utils.main_utils.utils import save_object,_load_object
...
class ModelTrainer:
    ...
    "Logistic Regression": LogisticRegression(),  # fixed before
    "AdaBoost": AdaBoostClassifier(),             # ✅ fixed now
}
        ...
        ##track the experments with MLFLOW
        ...
        preprocessor = _load_object(file_path=self.data_transformation_artifact.transformed_object_file_path)
