...
from networksecurity.utils.main_utils.utils import _load_object
...
async def predict_route(request:Request,file:UploadFile=File(...)):
    ...
    try:
        ...
        preprocessor = _load_object("final_model/preprocessor.pkl")
        final_model = _load_object("final_model/model.pkl")
